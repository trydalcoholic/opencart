...
// Developer
$_['dev_editor_protocol']   = 'auto'; // auto, vscode, phpstorm, sublime, atom, etc.
$_['dev_editor_custom_url'] = ''; // Custom editor URL pattern if needed
$_['dev_open_in_editor']    = true; // Enable/disable editor links
$_['dev_max_dump_depth']    = 10; // Maximum depth for variable dumping
$_['dev_max_dump_length']   = 1000; // Maximum string length in dumps
